...
public class Category_Activity extends AppCompatActivity {
    ...
    private void loadCate() {
        GridLayoutManager manager = new GridLayoutManager(Category_Activity.this, 2);
            ...
            protected void onBindViewHolder(@NonNull CategoryViewHolder holder, int position, @NonNull Category model) {
                ...
                holder.setItemClick(new ItemClick() {
                    ...
                    public void itemClick(View view, int position, boolean isLongClick) {
                        Toast.makeText(Category_Activity.this, "" + category.getName(), Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(Category_Activity.this, FoodActivity.class);
//                        Tạo key Category;
    ...
    private void showDialogThem() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Category_Activity.this);
    ...
    private void UploadImage() {
        if (saveUri != null) {
            ProgressDialog mDialog = new ProgressDialog(Category_Activity.this);
            ...
            imageFolder.putFile(saveUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    mDialog.dismiss();
                    Toast.makeText(Category_Activity.this, "Uploaded", Toast.LENGTH_SHORT).show();
